...
**     Processor : 56F8367
**     Component : 56F8367
**     Version   : Component 01.034, Driver 02.08, CPU db: 2.87.058
...
void _EntryPoint(void)
{
  ...
  setReg16(SEMI_CSBAR_0, 5U);          /* Chip select 0 base address register */ 
  /* SEMI_CSOR_0: RWS=1,BYTE_EN=3,R_W=3,PS_DS=2,WWS=1 */
  setReg16(SEMI_CSOR_0, 4033U);        /* Chip select 0 option register */ 
  /* SEMI_CSTC_0: WWSS=0,WWSH=0,RWSS=0,RWSH=0,??=0,??=0,??=0,??=0,??=0,MDAR=0 */
  setReg16(SEMI_CSTC_0, 0U);           /* Chip select 0 timing control register */ 
  ...
  setReg16(SEMI_CSBAR_1, 5U);          /* Chip select 1 base address register */ 
  /* SEMI_CSOR_1: RWS=1,BYTE_EN=1,R_W=3,PS_DS=1,WWS=1 */
  setReg16(SEMI_CSOR_1, 2977U);        /* Chip select 1 option register */ 
  /* SEMI_CSTC_1: WWSS=0,WWSH=0,RWSS=0,RWSH=0,??=0,??=0,??=0,??=0,??=0,MDAR=0 */
  setReg16(SEMI_CSTC_1, 0U);           /* Chip select 1 timing control register */ 
  /* SEMI_CSBAR_4: ADR23=0,ADR22=0,ADR21=0,ADR20=0,ADR19=0,ADR18=0,ADR17=0,ADR16=0,ADR15=0,ADR14=0,ADR13=0,ADR12=0,BLKSZ3=0,BLKSZ2=1,BLKSZ1=0,BLKSZ0=1 */
  setReg16(SEMI_CSBAR_4, 5U);          /* Chip select 4 base address register */ 
  /* SEMI_CSOR_4: RWS=1,BYTE_EN=2,R_W=3,PS_DS=1,WWS=1 */
  setReg16(SEMI_CSOR_4, 3489U);        /* Chip select 4 option register */ 
  /* SEMI_CSTC_4: WWSS=0,WWSH=0,RWSS=0,RWSH=0,??=0,??=0,??=0,??=0,??=0,MDAR=0 */
  setReg16(SEMI_CSTC_4, 0U);           /* Chip select 4 timing control register */ 
  /* GPIO_D_PER: PE|=772 */
  setReg16Bits(GPIO_D_PER, 772U);       
  /* SEMI_BCR: DRV=1,BMDAR=0,??=0,??=0,BWWS=1,BRWS=1 */
  setReg16(SEMI_BCR, 32801U);          /* Bus control register */ 
...
void PE_low_level_init(void)
{
  ...
  /* GPIO_F_PER: PE=65535 */
  setReg16(GPIO_F_PER, 65535U);         
  /* GPIO_A_PER: PE=16383 */
  setReg16Bits(GPIO_A_PER, 16383U);     
  /* GPIO_E_PER: PE|=12 */
  setReg16Bits(GPIO_E_PER, 12U);        
  MEM1_Init();                         /* ### DSP_MEM "MEM1" init code ... */
  /* ### FreeCntr "Inhr1" init code ... */
  Inhr1_Init();
  /* ### DSP_CycleCounter "CCNT1" init code ... */
  cycleCountCalibrate();
