...
#define DFR1_dfr16FIR(pFIR,pX,pZ,n) dfr16FIR(pFIR,pX,pZ,n)
/*
** ===================================================================
...
#define DFR1_dfr16FIRCreate(pC,n) dfr16FIRCreate(pC,n)
/*
** ===================================================================
...
#define DFR1_dfr16FIRDestroy(pFIR) dfr16FIRDestroy(pFIR)
/*
** ===================================================================
...
#define DFR1_dfr16FIRInit(pFIR, pC, n) dfr16FIRInit(pFIR, pC, n)
/*
** ===================================================================
...
#define DFR1_dfr16FIRHistory(pFIR, pX) dfr16FIRHistory(pFIR, pX)
/*
** ===================================================================
...
#define DFR1_dfr16FIRs(pFIR, X) dfr16FIRs(pFIR, X)
/*
** ===================================================================
...
#define DFR1_dfr16FIRInt(pFIRInt, pX, pZ, n) dfr16FIRInt(pFIRInt, pX, pZ, n)
/*
** ===================================================================
...
#define DFR1_dfr16FIRIntCreate(pC, n, f) dfr16FIRIntCreate(pC, n, f)
/*
** ===================================================================
...
#define DFR1_dfr16FIRIntDestroy(pFIRInt) dfr16FIRIntDestroy(pFIRInt)
/*
** ===================================================================
...
#define DFR1_dfr16FIRIntInit(pFIRInt, pC, n, f) dfr16FIRIntInit(pFIRInt, pC, n, f)
/*
** ===================================================================
...
#define DFR1_dfr16FIRDec(pFIRDec, pX, pZ, nx) dfr16FIRDec(pFIRDec, pX, pZ, nx)
/*
** ===================================================================
...
#define DFR1_dfr16FIRDecCreate(pC, n, f) dfr16FIRDecCreate(pC, n, f)
/*
** ===================================================================
...
#define DFR1_dfr16FIRDecDestroy(pFIRDec) dfr16FIRDecDestroy(pFIRDec)
/*
** ===================================================================
...
#define DFR1_dfr16FIRDecInit(pFIRDec, pC, n, f) dfr16FIRDecInit(pFIRDec, pC, n, f)
/*
** ===================================================================
...
#define DFR1_dfr16IIR(pIIR, pX, pZ, n) dfr16IIR(pIIR, pX, pZ, n)
/*
** ===================================================================
...
#define DFR1_dfr16IIRCreate(pC, nbiq) dfr16IIRCreate(pC, nbiq)
/*
** ===================================================================
...
#define DFR1_dfr16IIRDestroy(pIIR) dfr16IIRDestroy(pIIR)
/*
** ===================================================================
...
#define DFR1_dfr16IIRInit(pIIR, pC, n) dfr16IIRInit(pIIR, pC, n)
/*
** ===================================================================
...
#define DFR1_dfr16AutoCorr(options, pX, pZ, nx, nz) dfr16AutoCorr(options, pX, pZ, nx, nz)
/*
** ===================================================================
...
#define DFR1_dfr16Corr(options, pX, pY, pZ, nx, ny) dfr16Corr(options, pX, pY, pZ, nx, ny)
/*
** ===================================================================
...
#define DFR1_dfr16CFFT(pCFFT, pX, pZ) dfr16CFFT(pCFFT, pX, pZ)
/*
** ===================================================================
...
#define DFR1_dfr16CFFTCreate(n, options) dfr16CFFTCreate(n, options)
/*
** ===================================================================
...
#define DFR1_dfr16CFFTDestroy(pCFFT) dfr16CFFTDestroy(pCFFT)
/*
** ===================================================================
...
#define DFR1_dfr16CFFTInit(pCFFT, n, options) dfr16CFFTInit(pCFFT, n, options)
/*
** ===================================================================
...
#define DFR1_dfr16CIFFT(pCIFFT, pX, pZ) dfr16CIFFT(pCIFFT, pX, pZ)
/*
** ===================================================================
...
#define DFR1_dfr16CIFFTCreate(n, options) dfr16CIFFTCreate(n, options)
/*
** ===================================================================
...
#define DFR1_dfr16CIFFTDestroy(pCIFFT) dfr16CIFFTDestroy(pCIFFT)
/*
** ===================================================================
...
#define DFR1_dfr16CIFFTInit(pCIFFT, n, options) dfr16CIFFTInit(pCIFFT, n, options)
/*
** ===================================================================
...
#define DFR1_dfr16RFFT(pRFFT, pX, pZ) dfr16RFFT(pRFFT, pX, pZ)
/*
** ===================================================================
...
#define DFR1_dfr16RFFTCreate(n, options) dfr16RFFTCreate(n, options)
/*
** ===================================================================
...
#define DFR1_dfr16RFFTDestroy(pRFFT) dfr16RFFTDestroy(pRFFT)
/*
** ===================================================================
...
#define DFR1_dfr16RFFTInit(pRFFT, n, options) dfr16RFFTInit(pRFFT, n, options)
/*
** ===================================================================
...
#define DFR1_dfr16RIFFT(pRIFFT, pX, pZ) dfr16RIFFT(pRIFFT, pX, pZ)
/*
** ===================================================================
...
#define DFR1_dfr16RIFFTCreate(n, options) dfr16RIFFTCreate(n, options)
/*
** ===================================================================
...
#define DFR1_dfr16RIFFTDestroy(pRIFFT) dfr16RIFFTDestroy(pRIFFT)
/*
** ===================================================================
...
#define DFR1_dfr16RIFFTInit(pRIFFT, n, options) dfr16RIFFTInit(pRIFFT, n, options)
/*
** ===================================================================
...
#define DFR1_dfr16Cbitrev(pX, pZ, n) dfr16Cbitrev_(pX, pZ, n)
/*
** ===================================================================
