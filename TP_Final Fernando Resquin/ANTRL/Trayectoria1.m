...
Last_X = Tray.x(Tray.ind);%Posición de último punto de la trayectoria
Last_Y = Tray.y(Tray.ind);%Posición de último punto de la trayectoria
Orient = Get_Orient(Tray);%Orientación  a partir de los 2 últimos puntos
if(Orient == 1)
...
H.ind = Tray.ind;
if ~nargout
display('Función Trayectoria() - Se requieren argumentos')
return;
end
%Compilación exitosa.